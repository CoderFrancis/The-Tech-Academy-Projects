...
Namespace Controllers
    Public Class InsureeController
        ...
        Public Function Admin() As ActionResult
            Dim insureesWithQuotes = GetInsureesWithQuotes() ' Fetch the necessary data

            Return View(insureesWithQuotes)
        End Function

        ' Function to fetch the necessary data
        Private Function GetInsureesWithQuotes() As IEnumerable(Of Insuree)
                ' Logic to retrieve the insurees with quotes
                ' Replace this with your actual implementation

                Dim insurees As New List(Of Insuree)()
                ' Add sample data for demonstration
                insurees.Add(New Insuree With {.FirstName = "John", .LastName = "Doe", .EmailAddress = "john@example.com", .Quote = 100})
                insurees.Add(New Insuree With {.FirstName = "Jane", .LastName = "Smith", .EmailAddress = "jane@example.com", .Quote = 150})
