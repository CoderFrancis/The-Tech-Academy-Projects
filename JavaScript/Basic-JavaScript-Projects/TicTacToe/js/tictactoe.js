...
function placeXOrO(squareNumber)    {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber)))   {
        ...
        // This calls a function t check for any win conditions.
        checkWinConditions();
    ...
    function computersTurn()    {
        ...
        while (!success)    {
            ...
            // If the random number evaluated returns trye, the square hasn't been selected yet.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2)    {
    ...
    let x1 = coordX1;
        ...
        x2 = coordX2;
        // This line indicates where the end of a line x axis.
        y2 = coordY2,
